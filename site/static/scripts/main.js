...
if(saveData.theme == 0 || saveData.theme == null ){
    $("head").append('<link rel="stylesheet" href="static/stylesheets/dark.css" type="text/css" />')
    $("#themeEle").show()
} else{
    $("#theme").prop("checked", true)
    $("#themeEle").show()
    $("head").append('<link rel="stylesheet" href="static/stylesheets/light.css" type="text/css" />')
}
